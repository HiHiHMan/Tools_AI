...
function renderCategories(
    ...
    Object.keys(grouped).sort((a, b) => Number(a) - Number(b)).forEach(category => {
...
window.addEventListener(
    ...
    () => {
        ...
        heroImage.style.transform =
            `translate(-50%, calc(-50% + ${amount}px))`;
